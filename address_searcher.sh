...
main() {
    ...
    for f in $FORMAT_INDEX; do
        ...
        for p in {0..49}; do
            ...
            curl -s -o $OUTPUT_FILE https://searchcode.com/api/codesearch_I/?q=${SEARCH_STRING}&p=$p&per_page=100&loc=1000
            ...
            for k in $KEYS; do
                ...
                local readonly MATCH=$(echo $TMP | jq "." | jq ".lines" | egrep -o "$REGEXP")
