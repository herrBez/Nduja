...
class DbManager:
    ...
    def insertWallet(self, address: str, currency: str, status: Any) -> bool: ...

    def insertWalletWithAccount(self, address: str, currency: str, status: Any,
    ...
    def insertNewInfo(self, address: str, currency: str, status: str,
